...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cu4curAa.mjs");
...
var manifest = {
	"5c6f0cfb9eb6438d3bea40a1cd9a10b2e499c001974ba612cbe49f1c531af395": {
		functionName: "lookupBreachedAccount_createServerFn_handler",
		importer: () => import("./hibp-fn-DXlQBNU_.mjs")
	},
	"d9f38268cbd7e440e973d54135492e279a4eadfb3fb8ebfdb1bd30c5eed7bcf1": {
		functionName: "fetchPwnedRange_createServerFn_handler",
		importer: () => import("./hibp-fn-DXlQBNU_.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cd8d3wQ-.mjs").then((n) => n.t),
